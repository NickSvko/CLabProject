 ...
 * and updates in the symbol table the dataType of each symbol characterized as 'data',
 * and in the data image addresses of all the data, by adding the final dataType of the instruction counter to them.
 */
void updateValues(long* ICF, long* DCF, long IC, long DC, symbolTable symTab, dataTable dataTab)
{
	...
	*DCF = DC;
	...
	/* Updates in the symbol table the dataType of each symbol characterized as 'data', by adding the ICF dataType */
