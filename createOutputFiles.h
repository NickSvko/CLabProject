...
//void printByteOfType(directiveType dataType, void *currentVariable, int bytesReadFromVariable, FILE *fileDescriptor);
//bool lastByteLeftToPrint(directiveType dataType,int readBytes);
